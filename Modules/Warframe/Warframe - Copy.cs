...
//    using Warframebot;
//
//    var warframe = Warframe.FromJson(jsonString);
...
namespace Warframebot.Modules.Warframe
{
    public partial class Warframe
    {
        ...
        public List<TwitchPromo> TwitchPromos { get; set; }
    ...
    public partial class Event
    {
        ...
        public Activation EventStartDate { get; set; }

        [JsonProperty("EventEndDate", NullValueHandling = NullValueHandling.Ignore)]
        public Activation EventEndDate { get; set; }

        [JsonProperty("EventLiveUrl", NullValueHandling = NullValueHandling.Ignore)]
        public Uri EventLiveUrl { get; set; }
    }
    ...
    public partial class FeaturedGuild
    {
        [JsonProperty("_id")]
        public Id Id { get; set; }
    ...
    public partial class TwitchPromo
    {
        [JsonProperty("startDate")]
        public Activation StartDate { get; set; }
        ...
        public List<object> Streamers { get; set; }
